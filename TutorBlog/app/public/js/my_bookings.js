...
function displayBookings() {
  ...
  if (bookings.length === 0) {
    container.innerHTML =
      '<div class="post" style="padding: 30px; text-align: center;"> You have no bookings yet. <a href="../html/index.html" class="link_btn" style="display: inline-block; margin-top: 15px;">Browse Tutors</a></div>';
    return;
  }
